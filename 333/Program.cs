    ...
    static void Main()
    {
        try
        {
            ...
            using (MailMessage message = new MailMessage())
            {
                ...
                message.From = new MailAddress("npl1u1pc@mail.ru", "npl1u1pc@mail.ru", encoding);
                ...
                smtp.EnableSsl = true;
                smtp.Credentials = new System.Net.NetworkCredential("npl1u1pc@mail.ru", "8bcqM2Xs00QUfUMTqjYL");
